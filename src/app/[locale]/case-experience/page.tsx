...
export default function CaseExperiencePage() {
  ...
  return (
    <div className="bg-parchment min-h-screen">
      {/* HERO SECTION */}
      <section className="bg-ink pt-32 md:pt-48 pb-24 px-6 lg:px-12">
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif text-parchment mb-8">
              {tHero("title")}
            </h1>
            <p className="text-lg md:text-xl font-serif text-parchment/70 leading-relaxed max-w-3xl mx-auto">
              {tHero("intro")}
            </p>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="space-y-8 md:space-y-12 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gold/30 before:to-transparent">
            {methodSteps.map((step, index) => (
              ...
              >
                <div className="flex items-center justify-center w-10 h-10 rounded-full border-4 border-parchment bg-gold text-parchment shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 font-serif font-bold text-sm">
                  {index + 1}
                </div>
      ...
      <section className="py-24 md:py-32 px-6 lg:px-12 bg-ink text-parchment">
        <div className="container mx-auto max-w-6xl">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-serif text-parchment mb-6">{tMatters("heading")}</h2>
            <p className="text-sm md:text-base font-serif text-parchment/50 italic">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            {matters.map((matter, index) => (
              ...
              >
                ...
                <div className="pl-10">
                  <p className="font-serif text-parchment/70 leading-relaxed whitespace-pre-line text-sm md:text-base">
                    {matter.description}
                  </p>
                </div>
              </motion.div>
