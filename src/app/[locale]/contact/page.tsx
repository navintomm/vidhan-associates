      ...
      <section className="relative pt-40 pb-20 px-6 lg:px-12 border-b border-gold/10">
        <div className="container mx-auto max-w-5xl">
          ...
          <motion.h1
            ...
            className={`${locale === "ml" ? "text-3xl md:text-5xl lg:text-6xl break-words" : "text-5xl md:text-7xl"} font-serif text-parchment leading-tight mb-6 max-w-2xl`}
          >
            {t("hero.title")}
          </motion.h1>
          <motion.p
        ...
        <div className="container mx-auto max-w-5xl grid grid-cols-1 lg:grid-cols-5 gap-16">
          ...
          <div className="lg:col-span-3">
            {state === "success" ? (
              ...
              >
                ...
                <h2 className={`${locale === "ml" ? "text-xl md:text-2xl break-words whitespace-normal" : "text-2xl"} font-serif text-parchment`}>
                  {t("form.successTitle")}
                </h2>
                <p className="text-parchment/50 font-sans text-sm leading-relaxed">
                  {t("form.successDesc")}
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                {/* Name */}
                <div>
                  <label className="block text-sm tracking-wide-xl uppercase text-parchment/50 mb-3 break-words">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-transparent border border-gold/15 hover:border-gold/30 focus:border-gold/50 outline-none px-5 py-4 text-parchment placeholder-parchment/20 font-sans text-lg transition-colors cursor-text"
                    />
                  </div>
                  <div>
                    <label className="block text-sm tracking-wide-xl uppercase text-parchment/50 mb-3 break-words">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  ...
                  <button
                    ...
                    className="group flex-1 flex items-center justify-center gap-3 bg-gold/10 hover:bg-gold/20 border border-gold/20 hover:border-gold/40 px-6 py-5 text-sm tracking-wide-xl uppercase text-parchment/80 hover:text-parchment transition-all disabled:opacity-50 break-words"
                  >
                    {state === "sending" ? (
          ...
          <aside className="lg:col-span-2 space-y-12 pt-2">
            ...
            <div className="space-y-6">
              ...
              <div className="text-parchment/70 font-sans text-base leading-relaxed pl-2 break-words" dangerouslySetInnerHTML={{ __html: `<strong class="text-parchment font-serif font-medium text-lg">Vidhan Law Chambers</strong><br />${t("info.ernakulamAddress")}` }} />
            ...
            <div className="space-y-6">
              ...
              <div className="text-parchment/70 font-sans text-base leading-relaxed pl-2 break-words" dangerouslySetInnerHTML={{ __html: `<strong class="text-parchment font-serif font-medium text-lg">Vidhan Law Chambers</strong><br />${t("info.thrissurAddress")}` }} />
            ...
            <p className="text-xs tracking-wide text-parchment/40 leading-relaxed pt-4 break-words">
