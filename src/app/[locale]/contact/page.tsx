            ...
            {state === "success" ? (
              ...
              >
                ...
                <p className="text-parchment/50 font-sans text-sm leading-relaxed">
                  We will review your matter and get back to you within one business day.
                  For urgent matters, please use the WhatsApp button below.
                </p>
                <button
                  onClick={() => { setState("idle"); setForm({ name: "", phone: "", email: "", matter: "Civil Litigation", message: "" }); }}
                  className="text-xs tracking-wide-xl uppercase text-gold/60 hover:text-gold transition-colors"
                >
