export default function BlogPage() {
 return (
 <div className="min-h-[80vh] bg-parchment pt-32 md:pt-48 pb-24 flex flex-col items-center justify-center px-6 text-center">
 <div className="max-w-3xl mx-auto">
 <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-ink mb-6 leading-tight">
 Legal Insights Blog
 </h1>
 <p className="text-lg md:text-xl font-serif text-ink/70 mb-12">
