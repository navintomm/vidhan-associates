        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-[1.2fr_1fr] gap-12 md:gap-20 items-start">
            ...
            <motion.div
              ...
              className="bg-ink rounded-xl p-8 md:p-12 shadow-xl border border-gold/10"
            >
              ...
              <ul className="space-y-5">
                {courts.map((court, i) => (
                  <li key={i} className="text-parchment/90 font-sans text-base md:text-lg leading-relaxed">
                    {court}
                  </li>
                ))}
              </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
            {values.map((v, i) => (
              ...
              >
                ...
                <h3 className="text-2xl md:text-3xl font-serif text-parchment mb-5">{v.title}</h3>
                <p className="text-sm md:text-base text-parchment/60 font-serif leading-relaxed md:leading-loose">
                  {v.description}
                </p>
              </motion.div>
            ))}
