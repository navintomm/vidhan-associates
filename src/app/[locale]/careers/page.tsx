...
export default function CareersPage() {
 ...
 className="text-5xl md:text-7xl font-serif text-ink leading-tight max-w-4xl mx-auto mb-6"
 >
 {tHero("title")}
 </motion.h1>
 <motion.p
 ...
 className="text-lg md:text-xl text-ink/70 max-w-2xl mx-auto font-sans leading-relaxed"
 >
 {tHero("description")}
 </motion.p>
 </div>
 ...
 <p className="text-lg text-ink/70 max-w-2xl mx-auto mb-10 leading-relaxed">
 {tApply("description")}
 </p>
 ...
 <div className="text-left max-w-2xl mx-auto mb-12 space-y-4 font-sans text-ink/80">
 {instructions.map((instruction, index) => (
 <div key={index} className="flex items-start gap-3">
 <span className="text-gold mt-1">•</span>
 <p dangerouslySetInnerHTML={{ __html: instruction.replace(/\*\*(.*?)\*\*/g, '<strong class="text-ink">$1</strong>') }} />
 </div>
 ))}
 </div>

 <p className="text-sm font-sans text-ink/40 italic mb-10">
 {tApply("note")}
 </p>
