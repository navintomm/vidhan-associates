 ...
 const t = useTranslations("home.hero");
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden flex items-end pb-20 md:pb-28 bg-parchment">
      ...
      {/* Content */}
      <div className="relative z-20 container mx-auto px-6 lg:px-12 w-full h-full flex flex-col justify-center items-center text-center pt-32 md:pt-40 pb-16 md:pb-24">

        {/* Main Center-Aligned Text Group with CTA 30px below */}
        <div className="max-w-3xl flex flex-col items-center text-center">
          ...
          >
            {/* Top Tagline with dual gold accents */}
            ...
            {/* Display Sans Headline */}
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-sans font-black text-ink leading-[1.05] tracking-tight uppercase mb-6 text-center">
              The Pursuit <br />
              <span className="text-gold font-extrabold">of Justice</span>
            </h1>

            {/* Subtitle */}
            <p className="text-lg md:text-xl font-sans text-slate/85 leading-relaxed max-w-xl mx-auto text-center mb-0">
              Independent legal practice providing strategic counsel and principled advocacy across Kerala and beyond.
            </p>

            {/* Schedule a Consultation CTA — 30px down */}
