...
export default function BottomNav({}: { locale: string }) {
 ...
 return (
 <nav className="fixed bottom-0 w-full z-40 bg-parchment/90 backdrop-blur-sm border-t border-gold/10 hidden lg:block">
 ...
 <button
 onClick={scrollToTop}
 className="relative w-12 h-12 rounded-full flex items-center justify-center text-ink/70 hover:text-gold transition-colors group ml-8 flex-shrink-0"
 ...
 strokeWidth="1.5"
 fill="transparent"
 className="text-ink/20 group-hover:text-gold/30 transition-colors"
 />
 <circle
 cx="24"
 cy="24"
