...
export default function LandingSplash() {
 ...
 return <div className="fixed inset-0 z-[10000] bg-parchment" />;
 }
 ...
 className="fixed inset-0 z-[10000] bg-parchment flex items-center justify-center overflow-hidden"
 >
 ...
 className="absolute bottom-12 text-xs tracking-widest text-ink/30 uppercase hover:text-ink transition-colors z-50"
 >
 Skip Intro
 </motion.button>
